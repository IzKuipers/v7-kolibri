// Auto-generated arcos.d.ts

// ========== CONVERTED GLOBAL EXPORTS ==========
declare global {
  ...
  export const VALIDATION_STR =
    "thisWonderfulArcOSServerIdentifiedByTheseWordsPleaseDontSteal(c)IzKuipers";
  ...
  export class ShareManager extends BaseService {
    ...
    joinShare(
      ...
      password: string,
      mountAlso?: boolean
    ): Promise<boolean | FilesystemDrive>;
  ...
  export class TrayHostRuntime extends Process {
    ...
    createTrayIcon(
      ...
      process?: typeof TrayIconProcess
    ): Promise<boolean>;
    disposeTrayIcon(
      pid: number,
      identifier: string
  ...
  export class WallpaperRuntime extends AppProcess {
    ...
    render({ desktopDir }: { desktopDir: string }): Promise<void>;
  ...
  export class ArcFetchCommand extends TerminalProcess {
    ...
    getItems(term: ArcTerminal): [string, string][];
  ...
  export type CalculatorKey = [string | null, string | null];
  ...
  export class EditRowRuntime extends AppProcess {
    ...
    rows: ReadableStore<[number, [number, number][]][]>;
  ...
  export class HexEditRuntime extends AppProcess {
    ...
    hexRows: ReadableStore<[number, number][][]>;
    decoded: ReadableStore<[string, number][][]>;
  ...
  export interface MessagingPage {
    ...
    icon: string;
    supplier: (
      process: MessagingAppRuntime
    ) => Promise<PartialMessage[]> | PartialMessage[];
  }
  ...
  export class MessagingAppRuntime extends AppProcess {
    ...
    constructor(
      ...
      parentPid: number,
      app: AppProcessData,
      pageOrMessagePath?: string,
      messageId?: string
    );
    render({ page }: { page: string }): Promise<void>;
  ...
  export function WriterAccelerators(
  ...
  export function DefaultFileHandlers(
    daemon: UserDaemon
  ): Record<string, FileHandler>;
  ...
  export class AppProcess extends Process {
    ...
    spawnApp<T = AppProcess>(
      id: string,
      parentPid?: number | undefined,
      ...args: any[]
    ): Promise<T | undefined>;
    spawnOverlayApp<T = AppProcess>(
      id: string,
      parentPid?: number | undefined,
      ...args: any[]
    ): Promise<T | undefined>;
  ...
  // ========== GLOBAL BINDINGS FROM ThirdPartyProps ==========
  ...
  export const Server: typeof Axios;

  export const Debug: (m: any) => void;

  export const dayjs: typeof dayjs;
}
